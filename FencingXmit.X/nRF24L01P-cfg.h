...
#define NRF24_CSN_ACTIVE()  LATCbits.LATC3 = 0
#define NRF24_CSN_IDLE()    LATCbits.LATC3 = 1    
#define NRF24_CE_ACTIVE()   LATCbits.LATC4 = 1
#define NRF24_CE_IDLE()     LATCbits.LATC5 = 1
